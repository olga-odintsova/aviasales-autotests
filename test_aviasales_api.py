...
@allure.feature("Aviasales API: prices_for_dates")
class TestAviasalesPricesForDates:

    @allure.title("Успешный запрос: цены на даты (туда-обратно, RUB)")
    @allure.severity(allure.severity_level.CRITICAL)
    def test_prices_two_way_rub(self, api_client, base_params):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_prices_one_way(self, api_client, base_params):
    ...
    def test_prices_currency_gel(self, api_client, base_params):
        params = base_params.copy()
        params["currency"] = "gel"
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_bad_airport(self, api_client, base_params):
        params = base_params.copy()
        params["origin"] = "XXX"
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_wrong_method(self, api_client, base_params):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_no_token(self, api_client, base_params):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_wrong_token(self, api_client, base_params):
